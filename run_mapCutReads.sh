...
do
python 23.Oct.mapCutReads.py /mnt/Storage2/home/tuser/guch/MIR34/Output/seedContaining/${i}/${i}.seed.insert /mnt/Storage2/home/tuser/guch/MIR34/Output/seedContaining/${i}/${i}.seed.insert.splitBySeed.mapping.table TGGCAGTG
done
